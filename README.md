...
<ul>
<li>
<p>You are a freelance web developer. A client brings you a list of dogs<br>
(use the dogs.json file associated with this test), and wants you to<br>
make the list viewable, and editable, via the internet.</p>
</li>
<li>
<p>You should be able to update, read, delete and modify records.</p>
</li>
<li>
<p>Your dog list interface can be exposed however you like; GUI, raw<br>
data endpoints, anything is fine, as long as it is served over HTTP<br>
in a browser.</p>
</li>
<li>
<p>You can use any programming language, frameworks, methodologies,<br>
patterns, etc.</p>
</li>
</ul>
<h1 id="solution">Solution</h1>
<h2 id="live-instances">Live Instances</h2>
<ul>
<li>
...
<li>
<h3 id="aspnet-core-rest-api--httpsraedogrestapi.azurewebsites.netapidogbreed">ASPNET Core REST API:  <a href="https://raedogrestapi.azurewebsites.net/api/dogbreed">https://raedogrestapi.azurewebsites.net/api/dogbreed</a></h3>
</li>
</ul>
...
</table><h3 id="rest-server-functionality">REST Server Functionality</h3>
<ul>
...
<h3 id="react-dotnet--webapp-functionality">React dotNet  WebApp Functionality</h3>
<ul>
